...
questions_list.append(Question('Какого цвета нет на флаге Германии?',"Синий","Жёлтый","Красный","Чёрный"))
questions_list.append(Question('Сколько бойцов в Brawl Stars?',"72","70","71","69"))
...
RadioGroupBox=QGroupBox('Варианты овтетов')
